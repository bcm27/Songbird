...
namespace MusicTracker
{
    ...
    class Control
    {
        ...
        public List<string> opgave = null;
        public string savePSON = null;
        ...
        */
        public void loadFileDialog()
        {
            try {
                ...
                _openFileDialog1.Filter = "pson (*.pson)|*.pson|All files (*.*)|*.*";
                _openFileDialog1.Title = "Open PSON File";
                _openFileDialog1.CheckFileExists = true;
                var thread = new Thread(new ParameterizedThreadStart(param => {

                    if (_openFileDialog1.ShowDialog() != System.Windows.Forms.DialogResult.OK)
                    {
                        opgave = new List<string>();
                        opgave.Add("-1");
                        return;
                    ...
                    {
                        sFileName = _openFileDialog1.FileName;
                        string[] semp = File.ReadAllLines(sFileName);
                        opgave = semp.ToList();
        ...
        public void saveFileDialog()
        {
            ...
            _saveFileDialog1.Filter = "pson (*.pson)|*.pson|All files (*.*)|*.*";
            _saveFileDialog1.Title = "Save PSON File";
            _saveFileDialog1.CheckFileExists = false;
            var thread = new Thread(new ParameterizedThreadStart(param => {
                ...
                else
                {
                    ...
                    savePSON = _saveFileDialog1.FileName;
